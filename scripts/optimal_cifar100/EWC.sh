...
# Usage example: ./scripts/optimal_cifar100/EWC.sh cifar100 0
DATASET="${1:-"cifar100"}"
...
python -u experiment.py --scenario class_iid --dataset $DATASET --dataroot $DATAROOT  --lr 0.0001 --reg_coef 100 --n_epoch_first_task 10 --n_runs 10 --model_type squeezenet --model_name SqueezeNet --pretrained --agent_type regularization --agent_name EWC  --gpuid $GPU --momentum 0.9 --weight_decay 0.0001 --batch_size 21 --n_workers 8 --output_dir $OUTDIR --keep_best_task1_net | tee ${OUTDIR}/class_iid/EWC_SqueezeNet/log.log
python -u plot.py --n_class_per_task 5 --scenario class_iid --output_dir $OUTDIR --result_dir EWC_SqueezeNet
mv plots/EWC_class_iid.png ${OUTDIR}/class_iid/EWC_SqueezeNet/EWC_class_iid.png