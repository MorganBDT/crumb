...
DATASET="${1:-"core50"}"
GPU="${2:-0}"
SUFFIX="${3:-"_adaptive_storage_sample_first_batch"}"
LR=${4:-0.001}
PRETRAIN_RUN="${5:-0}"
...
if [ "$DATASET" = "core50" ]; then
    ...
    DDATAROOT="/media/KLAB37/datasets/"
    MEMORY_SIZE=834
    BATCH_SIZE=21
    N_RUNS=10
