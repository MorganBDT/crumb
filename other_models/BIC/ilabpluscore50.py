...
class Ilabpluscore50:
    def __init__(self, paradigm, run):
        ...
        print("this is train self.train in ilab2mlight+core50")
...
if __name__ == "__main__":
    dset = Ilabpluscore50(paradigm = 'class_iid', run = 0)
