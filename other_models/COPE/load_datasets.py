...
def load_datasets(args):
    ...
    if args.dataset == 'ilab2mlight+core50':
        ...
        # if os.path.exists('ilab2mlight+core50.pt'):
        # x_tr, y_tr, x_te, y_te = torch.load('ilab2mlight+core50.pt')
        if os.path.exists('ilab2mlight+core50' + str(args.run) + '_' + args.paradigm + '.pt'):
            x_tr, y_tr, x_te, y_te = torch.load('ilab2mlight+core50' + str(args.run) + '_' + args.paradigm + '.pt')
        else:
            ...
            for t in range(args.n_tasks):
                with open(rootdir + args.paradigm + '/run' + str(args.run) + '/stream/train_task_' + str(t).zfill(
                        2) + '_filelist.txt', 'r') as f:
            ...
            # torch.save((x_tr, y_tr, x_te, y_te), 'ilab2mlight+core50.pt')
            torch.save((x_tr, y_tr, x_te, y_te), 'ilab2mlight+core50' + str(args.run) + '_' + args.paradigm + '.pt')
    ...
    if args.dataset == 'icubworldtransf':
        ...
        # if os.path.exists('icubworldtransf.pt'):
        # x_tr, y_tr, x_te, y_te = torch.load('icubworldtransf.pt')
        if os.path.exists('icubworldtransf' + str(args.run) + '_' + args.paradigm + '.pt'):
            x_tr, y_tr, x_te, y_te = torch.load('icubworldtransf' + str(args.run) + '_' + args.paradigm + '.pt')
        else:
            print('started loading train data')
            ...
            print('finished loading test data')
            # torch.save((x_tr, y_tr, x_te, y_te), 'icubworldtransf.pt')
            torch.save((x_tr, y_tr, x_te, y_te), 'icubworldtransf' + str(args.run) + '_' + args.paradigm + '.pt')
            print('finished saving data')
    ...
    if args.dataset == 'core50':
        ...
        #dataroot = '/media/data/Datasets/ImageNet2012/'
        ...
        if os.path.exists('imagenet' + str(args.run) + '_' + args.paradigm + '.pt'):
            x_tr, y_tr, x_te, y_te = torch.load('imagenet' + str(args.run) + '_' + args.paradigm + '.pt')
        else:
            print('started loading train data')
            ...
            print('finished loading test data')
            torch.save((x_tr, y_tr, x_te, y_te), 'imagenet' + str(args.run) + '_' + args.paradigm + '.pt')
            print('finished saving data')
