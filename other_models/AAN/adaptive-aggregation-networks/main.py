...
if __name__ == '__main__':
    ...
    parser.add_argument('--filelist_root', default='dataloaders', type=str)
    parser.add_argument('--offline', default = False, action = 'store_true', dest = 'offline', help = "offline vs online (stream learning) training")
    parser.add_argument('--runs', type = int, default = 0, help = "Number of times to repeat the experiment with different data orderings")    
    ...
    parser.add_argument('--train_batch_size', default=100, type=int, help='the batch size for train loader')
