...
from squeezenet_models import *
from CRUMB_data_loaders import get_data_loader
import time

parser = argparse.ArgumentParser(description='PyTorch ImageNet Training')
parser.add_argument('--do_not_train', default=False, action='store_true', dest='do_not_train')
...
parser.add_argument('-b', '--batch_size', default=21, type=int,
                    metavar='N',
...
parser.add_argument('--images_dir', type=str, default=None)  # Dataset location
parser.add_argument('--task', type=int, default=0) # do not set this to anything else..
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_loader = get_data_loader('train', min_class=0, max_class=args.base_max_class, args=args)

    val_loader = get_data_loader('val', min_class=0, max_class=args.base_max_class, args=args)
