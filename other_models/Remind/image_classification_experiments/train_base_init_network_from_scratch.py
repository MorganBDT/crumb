...
parser.add_argument('--nonpretrained', action='store_true',
                    help='Add this flag to begin with a non-pretrained backbone CNN')
best_acc1 = 0
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = eval(args.arch)(pretrained=(not args.nonpretrained), num_classes=args.num_classes)
